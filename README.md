...
## JIRA Ticket
Fixes JIRA: https://phaneendravaranasi.atlassian.net/browse/SAM1-155
...
- [x] Commit message references JIRA key: `SAM1-155`
- [x] PR title follows convention: `fix: <description> [SAM1-155]`
